...
public class AccountService implements IAccountService {
	...
	public AccountDTO createAccount(long accountNumber, String customerName) {
		...
		logger.error("createAccount with parameters accountNumber= "
	...
	public void deposit(long accountNumber, double amount) {
		...
		logger.error("deposit with parameters accountNumber= " + accountNumber
				+ " , amount= " + amount);
		if (amount > 10000) {
	...
	public void withdraw(long accountNumber, double amount) {
		...
		accountDAO.save(account);
		publisher.publishEvent(new AccountChangeEvent("withdraw", accountNumber, amount));
		logger.trace("withdraw with parameters accountNumber= " + accountNumber
				+ " , amount= " + amount);
	}
	...
	public void depositEuros(long accountNumber, double amount) {
		...
		logger.debug("depositEuros with parameters accountNumber= "
